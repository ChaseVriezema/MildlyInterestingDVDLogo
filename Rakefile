...
Motion::Project::App.setup do |app|
  ...
  # ===========================================================================================
  app.name = 'DVDLogoThing'

  # version for your app
  app.version = '10.0'
  app.deployment_target = '10.0'
  app.name = 'DVDLogo'
  app.identifier = 'com.cmvriezema.sandbox'
  app.codesign_certificate = 'iPhone Developer: Chase Vriezema'
  app.provisioning_profile = '../DVDLogo_Provis.mobileprovision'
  # ===========================================================================================
